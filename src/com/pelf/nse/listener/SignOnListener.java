...
import com.pelf.server.util.FileUploader;
...
public class SignOnListener {
    ...
    public static void main(String[] args) throws UnknownHostException, IOException {
    	//BufferedReader br = new BufferedReader(new InputStreamReader(new FileInputStream("\\contract.txt")));
        ...
        try {
            ...
            FileUploader.uploadFile("//contract.txt", ip, echoSocket);
